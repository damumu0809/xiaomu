...
| 2016.03.24 | 1.[通过AJAX请求数据](./java/lesson1/use-ajax-get-json.md)<br/>2.[JSP访问数据库](./java/lesson1/jsp-mysql.md) |是|201603.24|写了通信作业 AND 好像有什么烦心事 希望你快乐|
| 2016.03.25 | 1.[通过AJAX请求数据](./java/lesson1/use-ajax-get-json.md)<br/>2.[JSP访问数据库](./java/lesson1/jsp-mysql.md) <br/>3.学习Node.js异步爬虫|是|2016.03.25|Good JOb！别睡太晚好好休息～（！补充：我以为是在学习，结果是在看剧😂）|
| 2016.03.26 | 1.[通过AJAX请求数据](./java/lesson1/use-ajax-get-json.md)<br/>2.[JSP访问数据库](./java/lesson1/jsp-mysql.md) <br/>3.学习Node.js异步爬虫||||
