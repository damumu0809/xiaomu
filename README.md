...
| 2016.03.20 | 1.在腾讯云服务器上[配置LEMP开发环境](./linux/install-php-mysql-nginx-stack-on-ubuntu.md)<br/>2.购买域名并在服务器上配置网站<br/>3.[学习使用MarkDown语法](./pages/markdown.md)<br/>4.完成研究开发实践老师布置的部分作业||||
